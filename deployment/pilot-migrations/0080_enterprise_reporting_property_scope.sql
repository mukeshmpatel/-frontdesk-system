...
CREATE TABLE IF NOT EXISTS report_run_receipts (
  ...
  report_id TEXT NOT NULL,filters_json TEXT NOT NULL,source_coverage_json TEXT NOT NULL,
  result_row_count INTEGER NOT NULL CHECK(result_row_count>=0),result_sha256 TEXT NOT NULL,
